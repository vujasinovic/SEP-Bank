...
insert into Account(id, amount) values (4, 0.00);
...
insert into Client(id, first_name, last_name, merchant_id, merchant_password, account_id) values (4, 'Naovis doo', 'Naovis', 'ziko', 'ziguli', 4);

insert into Card(id, holder_name, pan, security_code, valid_to, account) values (1, 'John Doe',  '1234-1234-1234-1234', 666, '2021-12-12', 1);
...
--insert into Payment(id, amount, url, account_id, merchant_id, success_url, failed_url, error_url) values (1, 120.0, '123456789', 1, 4, 'https://www.google.com', 'https://github.com', 'https://www.ftn.uns.ac.rs');
